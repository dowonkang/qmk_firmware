...
const uint16_t PROGMEM ent_combo[]  = {KC_SCOLON, KC_SLASH, COMBO_END};
const uint16_t PROGMEM bspc_combo[] = {KC_P, KC_SCOLON, COMBO_END};
const uint16_t PROGMEM lsft_combo[] = {KC_G, KC_B, COMBO_END};
const uint16_t PROGMEM lctl_combo[] = {KC_F, KC_V, COMBO_END};
const uint16_t PROGMEM lalt_combo[] = {KC_D, KC_C, COMBO_END};
const uint16_t PROGMEM lgui_combo[] = {KC_S, KC_X, COMBO_END};
const uint16_t PROGMEM rsft_combo[] = {KC_H, KC_N, COMBO_END};
const uint16_t PROGMEM rctl_combo[] = {KC_J, KC_M, COMBO_END};
const uint16_t PROGMEM ralt_combo[] = {KC_K, KC_COMMA, COMBO_END};
const uint16_t PROGMEM rgui_combo[] = {KC_L, KC_DOT, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
    // clang-format off
    [CB_TAB] = COMBO(tab_combo, KC_TAB),
    [CB_GRV] = COMBO(grv_combo, KC_GRV),
    [CB_ENT] = COMBO(ent_combo, KC_ENTER),
    [CB_BSPC] = COMBO(bspc_combo, KC_BSPACE),
