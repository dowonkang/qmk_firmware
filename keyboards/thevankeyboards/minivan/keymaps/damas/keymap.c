...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_ESC , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_QUOT, KC_MINS, KC_EQL , KC_LBRC, KC_RBRC, _______,
        _______, KC_MINS, KC_PLUS, KC_COMM, KC_DOT , KC_ENT , KC_BSLS, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______,
