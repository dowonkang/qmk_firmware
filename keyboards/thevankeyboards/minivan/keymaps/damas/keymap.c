...
// Shortcuts
#define FN_TAB LT(_NAV_NUMPAD, KC_TAB)
#define FN_ESC LT(_ARROW_FUNCTION, KC_ESCAPE)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ARROW_FUNCTION] = LAYOUT(
        TO_MOUS, KC_HOME, KC_UP  , KC_END , KC_VOLU, KC_PSCR, XXXXXXX, KC_F1  , KC_F2  , KC_F3  , KC_F4  , _______,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLD, KC_SLCK, XXXXXXX, KC_F5  , KC_F6  , KC_F7  , KC_F8  , _______,
    ...
    [_NAV_NUMPAD] = LAYOUT(
        _______, KC_WBAK, KC_HOME, KC_PGUP, KC_VOLU, KC_PSCR, KC_NLCK, KC_P7  , KC_P8  , KC_P9  , KC_PMNS, _______,
        _______, KC_WFWD, KC_END , KC_PGDN, KC_VOLD, KC_SLCK, KC_TAB , KC_P4  , KC_P5  , KC_P6  , KC_PPLS, _______,
        _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PAUS, XXXXXXX, KC_P1  , KC_P2  , KC_P3  , KC_PENT, _______,
        _______, _______, _______,          KC_SPC          ,          KC_P0           , KC_P0  , KC_PDOT, _______
    ),
    [_MOUSE] = LAYOUT(
        TO_BASE, KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, XXXXXXX, XXXXXXX,
        TO_BASE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX, XXXXXXX,
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        _______, _______, _______,          KC_BTN1         ,          KC_BTN2         , KC_BTN3, XXXXXXX, XXXXXXX
    ),
    [_ADJUST] = LAYOUT(
...
uint32_t layer_state_set_user(uint32_t state) {
    ...
    if (layer_state_cmp(state, _ARROW_FUNCTION)) {
        led0r = 255;
    }
    if (layer_state_cmp(state, _NAV_NUMPAD)) {
        led0g = 255;
    }
    setrgb(led0r, led0g, led0b, (LED_TYPE *)&led[0]);
#endif  // RGBLIGHT_ENABLE
    return update_tri_layer_state(state, _ARROW_FUNCTION, _SYMBOLS, _ADJUST);
}
