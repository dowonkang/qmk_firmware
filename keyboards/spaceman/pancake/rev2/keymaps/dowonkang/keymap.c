...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMPAD] = LAYOUT_ortho_4x12(
        // clang-format off
        _______, _______, KC_HOME, KC_UP  , KC_END , KC_VOLU, KC_NUM , KC_P7  , KC_P8  , KC_P9  , KC_PMNS, _______,
    ...
    [_FN] = LAYOUT_ortho_4x12(
        ...
        _______, _______, _______, _______, WBTM   , SCRSH_P, KC_SCRL, KC_F5  , KC_F6  , KC_F7  , KC_F8  , _______,
