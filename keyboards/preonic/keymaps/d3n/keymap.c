...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───────┼───────┼───────┼───────┼───────┴───────┼───────┴───────┼───────┼───────┼───────┼───────┤
     * │ ROTARY│ DANCE │  Alt  │ Super │  Space/Lower  │  Raise/Space  │ Left  │ Down  │  Up   │ Right │
     * └───────┴───────┴───────┴───────┴───────────────┴───────────────┴───────┴───────┴───────┴───────┘
     */
    [_BASE] = LAYOUT_preonic_2x2u(
        ...
        _______, DANCE,   KC_LALT, KC_LGUI,          LOW_SPC, RSE_SPC,          CTL_LFT, ALT_DN,  KC_UP,   CTL_RGT
    ),
    ...
    [_NUMPAD] = LAYOUT_preonic_2x2u(
        ...
        _______, _______, _______, _______,          _______,          KC_P0,   KC_P0,   KC_PDOT, _______, _______
    ),
    ...
    [_MOUSE] = LAYOUT_preonic_2x2u(
        ...
        _______, _______, _______, _______,          KC_BTN1, KC_BTN2,          KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R
    ),
